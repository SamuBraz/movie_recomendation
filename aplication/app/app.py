...
from app.blueprints.seus_filmes.routes import seus_filmes
...
def create_app():
    ...
    #TODO: Mudar senha e colocar em um .env
    ...
    app.register_blueprint(seus_filmes, url_prefix='/seus_filmes')
